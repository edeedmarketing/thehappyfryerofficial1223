...
const Header = () => {
  ...
  const logoTextClasses = shouldBeTransparent ? 'text-white' : 'text-gray-900';
  const activeClasses = shouldBeTransparent ? 'text-white font-semibold' : 'text-blue-600 font-semibold';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-3">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link
              to="/order"
              className="flex items-center space-x-2 bg-blue-600 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-blue-700 transition-colors"
            >
              <ShoppingBag size={16} />
              <span>Order Now</span>
            </Link>
            <a
              ...
              className={`p-2 transition-colors duration-500 ${textClasses} hover:text-blue-600`}
